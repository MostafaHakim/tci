...
//               <div className="absolute inset-x-0 top-10 sm:top-80 md:top-100 lg:top-150 p-2 md:p-6 bg-gradient-to-tr from-black/60 to-transparent text-white ">
//                 {slide.tag && (
...
//                 )}
//                 {slide.caption && (
//                   <p className="text-xs md:text-sm font-semibold drop-shadow-sm">
//                     {slide.caption}
//                   </p>
//                 )}
//               </div>
